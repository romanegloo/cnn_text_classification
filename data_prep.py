...
CONF = {
    ...
    'file_desc2017': DATA_ROOT + '/MeSH/desc2017.xml',
...
def sent_embedding(sents, seq_len, emb_len=200):
    global wv
...
if __name__ == '__main__':
    ...
    parser.add_argument("command", help="run different subtasks",
                        choices=['getMesh', 'getDist', 'getDatasets', 'test'])
    ...
    if args.command == 'getMesh':
        ...
        x, y = load_data_and_labels("data/pdata.train", 44, 200)
        print(type(x), type(y))
        print(x[0])
